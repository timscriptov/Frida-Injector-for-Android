...
public class KeysInterpreter {
    public static boolean isSwitchPanel(@NotNull KeyEvent event) {
    ...
    private static boolean isTab(@NotNull KeyEvent event) {
        return (event.isShiftPressed() &&
                (event.getKeyCode() == KeyEvent.KEYCODE_SPACE)) ||
                (event.getKeyCode() == KeyEvent.KEYCODE_TAB);
    }

    private static boolean isBackspace(@NotNull KeyEvent event) {
        return (event.getKeyCode() == KeyEvent.KEYCODE_DEL);
    }

    private static boolean isNewline(@NotNull KeyEvent event) {
        return (event.getKeyCode() == KeyEvent.KEYCODE_ENTER);
    }

    private static boolean isSpace(@NotNull KeyEvent event) {
        return (event.getKeyCode() == KeyEvent.KEYCODE_SPACE);
    }

    public static boolean isNavigationKey(@NotNull KeyEvent event) {
