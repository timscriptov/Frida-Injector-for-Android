...
import com.mcal.fridainjectorpe.editor.lang.LanguageNonProg;
...
public class AutoCompletePanel {
    ...
    public AutoCompletePanel(@NotNull FreeScrollingTextField textField) {
    ...
    private void initAutoCompletePanel() {
        ...
        _adapter = new MyAdapter(_context, android.R.layout.simple_list_item_single_choice);
        ...
        _autoCompletePanel.setOnItemClickListener((p1, p2, p3, p4) -> {
            _textField.replaceText(_textField.getCaretPosition() - _constraint.length(), _constraint.length(), ((AppCompatTextView) p2).getText().toString());
            _adapter.abort();
            dismiss();
        });
    ...
    class MyAdapter extends ArrayAdapter<String> implements Filterable {
        ...
        public int getItemHeight() {
            ...
            AppCompatTextView item = (AppCompatTextView) inflater.inflate(android.R.layout.simple_list_item_1, null);
            item.measure(0, 0);
